...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260529131311_UpdateEmbeddingDimension")]
            ...
            modelBuilder.Entity("Domain.Notes.Note", b =>
                {
                    ...
                    b.OwnsMany("Domain.Notes.NoteId", "LinkedNoteIds", b1 =>
                        {
                            b1.Property<Guid>("note_id")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("note_id", "Value");

                            b1.ToTable("note_links", null, t =>
                                {
                                    t.HasComment("筆記間的引用關聯，對應 [[noteId]] 語法");
                                });
